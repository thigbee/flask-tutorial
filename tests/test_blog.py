...
All the blog views use the auth fixture you wrote earlier. Call auth.login() and 
...
test data. When logged in as the author, there should be a link to edit the post.
...
A user must be logged in to access the create, update, and delete views. The logged 
in user must be the author of the post to access update and delete, otherwise a 
403 Forbidden status is returned. If a post with the given id doesn’t exist, 
